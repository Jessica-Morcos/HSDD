  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <header className="items-center justify-between mb-8 bg-[#b0372b] p-4">
        <PatientNav activePage="View Predictions" />
      </header>

      <div className="m-6">
        <h1 className="text-3xl font-bold mb-4">View Predictions</h1>
        ...
        <div className="bg-white border border-gray-300 rounded-lg p-6 max-w-xl shadow-sm mb-10">
          ...
          {latestPrediction.doctor && (
            <p className="text-xs text-gray-500 mt-1">
              Reviewed by{" "}
              <span className="font-semibold">{latestPrediction.doctor}</span>
            </p>
          )}
