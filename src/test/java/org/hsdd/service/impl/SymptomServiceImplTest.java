...
class SymptomServiceImplTest {
    ...
    void submit_successfulFlow_returnsSubmitSymptomResponse() {
        ...
        SymptomEntry savedSymptom = new SymptomEntry("PAT-12345", "Severe headaches", "[\"migraine\",\"vision\"]");
        ...
        // Verify save
        verify(symptoms, times(1)).save(any(SymptomEntry.class));
        verify(predictions).inferAndSave(any(SymptomEntry.class), eq("actorX"), eq("5.5.5.5"));
    }
    ...
    void submit_correctlyParsesTagsJson() {
        ...
        SymptomEntry saved = new SymptomEntry("PAT-99999", "Fatigue", "[\"tired\",\"low_energy\"]");
        saved.setId(20L);
